...
- Then, this filter will add "\newacronym{LRU}{LRU}{Least Recently Used} for the definition of LRU and finally \gls{
LRU} to every time the term is used in the text."
(see https://groups.google.com/forum/#!topic/pandoc-discuss/Bz1cG55BKjM)

Edited from https://github.com/sergiocorreia/panflute-filters/blob/master/filters/acronyms.py by Dries Kennes
The template must include the acronyms variable somewhere.
"""
